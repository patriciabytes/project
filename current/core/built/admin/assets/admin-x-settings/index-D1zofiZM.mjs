import { a$ as Oe, X as Xa, b1 as ll } from "./index-DbJiQD3s.mjs";
function fl(r, e) {
...
* limitations under the License.
*/
var rE = Jr, eE = Zs, ta = _n, tE = Xs, nE = XS, Dr = KS, Qs;
function iE() {
  var r;
  if (ta(Dr) === "undefined")
    return !1;
  for (r in Dr)
    try {
      eE(nE, r) === -1 && rE(Dr, r) && Dr[r] !== null && ta(Dr[r]) === "object" && tE(Dr[r]);
    } catch {
      return !0;
    }
  return !1;
...
* limitations under the License.
*/
var hE = Os, $t = Jr, vE = Js, mE = HS, yE = YS, pE = cE, ia = dE;
function gE(r) {
  var e, n, t, i, a, l, u;
  if (i = [], vE(r)) {
...
* limitations under the License.
*/
var bE = nS, wE = aS, SE = Fn, EE = LS, TE = $E, ke;
...
* limitations under the License.
*/
var ru = In, AE = ru.getOwnPropertyNames;
function CE(r) {
  return AE(ru(r));
}
var NE = CE;
...
* limitations under the License.
*/
var b2 = Fs, w2 = Dn, S2 = b2(w2.from), E2 = S2;
/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
...
* limitations under the License.
*/
var J2 = z2, X2 = H2, Q2 = q2, aa = Y2;
function K2() {
  var r, e;
  if (typeof aa != "function")
    return !1;
  try {
    e = new aa([1, 3.14, -3.14, X2 + 1]), r = J2(e) && e[0] === 1 && e[1] === 3 && // truncation
    e[2] === -3 && // truncation
    e[3] === Q2;
  } catch {
    r = !1;
...
* limitations under the License.
*/
var je = Jr, Pn = rt, va = pe, r_ = Gb, ma = _n, e_ = Ew, t_ = Zs, iu = Ks, n_ = RE, de = XE, i_ = Ms, he = vs, a_ = L2, o_ = Kx;
function s_(r) {
  var e, n, t, i, a, l, u, d;
...
//# sourceMappingURL=index-D1zofiZM.mjs.map
